...
using CTM_CustomerConsent.API.HealthCheck;
using CTM_CustomerConsent.API.Middleware;
using CTM_CustomerConsent.API;
using Newtonsoft.Json.Converters;
using Swashbuckle.AspNetCore.SwaggerUI;
using System.Text;
using APSharing.WebHttpClient;
using CTM_CustomerConsent.Service; 
using Serilog;
...
ServicesDependencyContainer.RegisterServices(builder.Services);
MST_General.Service.ServicesDependencyContainer.RegisterServices(builder.Services);
PRJ_Project.Service.ServicesDependencyContainer.RegisterServices(builder.Services);
...
var basePath = "api/v1/apcrm-ctm-customerconsent-service";
