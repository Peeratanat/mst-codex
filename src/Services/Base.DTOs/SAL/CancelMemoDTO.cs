...
namespace Base.DTOs.SAL
{
    public class CancelMemoDTO : BaseDTO
    {
        ...
        public static async Task<CancelMemoDTO> CreateFromModelAsync(CancelMemo model, DatabaseContext DB)
        {
            if (model != null)
            {
                ...
                CancelMemoDTO result = new CancelMemoDTO()
                {
        ...
        public static async Task<CancelMemoDTO> CreatePreobookFromModelAsync(PaymentMethodPrebook model)
        {
            if (model != null)
            {
                CancelMemoDTO result = new CancelMemoDTO()
                {
                    Project = ProjectDropdownDTO.CreateFromModel(model.PaymentPrebook.Quotation.Project),
                    Unit = UnitDropdownDTO.CreateFromModel(model.PaymentPrebook.Quotation.Unit),
                    TotalReceivedAmount = model.PayAmount,
                    ReturnCitizenIdentityNo = model.PaymentPrebook.CustomerCitizenIdentityNo,
                    PaymentMethodPreBookID = model.ID,
                    PaymentPreBookID = model.PaymentPrebook.ID,       
                    CustomerName = model.PaymentPrebook.CustomerFirstName,
                    CustomerLastName = model.PaymentPrebook.CustomerLastName
                    //ApproveDate = model.ApproveDate,
                    //ApproveByUser = UserDTO.CreateFromModel(model.ApproveByUser)
                };
