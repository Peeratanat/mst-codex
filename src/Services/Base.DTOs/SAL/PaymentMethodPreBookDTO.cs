...
namespace Base.DTOs.SAL
{
    ...
    /// Model: PaymentMethod
    /// </summary>
    public class PaymentMethodPreBookDTO : BaseDTO
    {
        /// <summary>
        /// จำนวนเงินที่จ่าย
        /// </summary>
        ...
        public static PaymentMethodPreBookDTO CreateFromModel(PaymentMethodPrebook model)
        {
            if (model != null)
            {
                PaymentMethodPreBookDTO result = new PaymentMethodPreBookDTO()
                {
                    Id = model.ID,
                    ...
                    PaymentID = model.PaymentPrebookID,
                    ...
                    DepositRemark = model.DepositRemark,
        ...
        public static PaymentMethodPreBookDTO CreateFromListModel(QuotationPreBookQueryResult model)
        {
            if (model != null)
            {
                PaymentMethodPreBookDTO result = new PaymentMethodPreBookDTO()
                {
                    Id = model.PaymentMethodPrebook.ID,
                    FeeIncludingVat = model.PaymentMethodPrebook.FeeIncludingVat,
                    IsForeignCreditCard = model.PaymentMethodPrebook.IsForeignCreditCard,
                    BankBranchName = model.PaymentMethodPrebook.BankBranchName,
                    Number = model.PaymentMethodPrebook.Number,
                    Bank = BankDropdownDTO.CreateFromModel(model.Bank),
                    // BankAccount = BankAccountDropdownDTO.CreateFromModel(model.DirectCreditDebitExportDetailID != null ? model.DirectCreditDebitExportDetail.DirectCreditDebitApprovalForm.BankAccount :  model.BankAccount),

                    ChequeDate = model.PaymentMethodPrebook.ChequeDate,
                    CreditCardPaymentType = MasterCenterDropdownDTO.CreateFromModel(model.CreditCardPaymentType),
                    CreditCardType = MasterCenterDropdownDTO.CreateFromModel(model.CreditCardType),

                    EDCBank = BankDropdownDTO.CreateFromModel(model.EDCBank),
                    Fee = model.PaymentMethodPrebook.Fee,
                    FeeConfirmByUser = UserDTO.CreateFromModel(model.FeeConfirmByUser),
                    FeeConfirmDate = model.PaymentMethodPrebook.FeeConfirmDate,
                    FeePercent = model.PaymentMethodPrebook.FeePercent,

                    IR = model.PaymentMethodPrebook.IR,
                    IsFeeConfirm = model.PaymentMethodPrebook.IsFeeConfirm,
                    IsNotifyFET = model.PaymentMethodPrebook.IsNotifyFET,
                    IsRequestFET = model.PaymentMethodPrebook.IsRequestFET,
                    IsWrongAccount = model.PaymentMethodPrebook.IsWrongAccount ?? false,
                    NotifyFETMemo = model.PaymentMethodPrebook.NotifyFETMemo,
                    PayAmount = model.PaymentMethodPrebook.PayAmount,
                    PaymentID = model.PaymentMethodPrebook.PaymentPrebookID,
                    PaymentMethodType = MasterCenterDropdownDTO.CreateFromModel(model.PaymentMethodType),
                    PayToCompany = CompanyDropdownDTO.CreateFromModel(model.PayToCompany),
                    TransferorName = model.PaymentMethodPrebook.TransferorName,

                    Updated = model.PaymentMethodPrebook.Updated,
                    UpdatedBy = model.UpdatedBy?.DisplayName,
                    Vat = model.PaymentMethodPrebook.Vat,
                    IsDeposited = model.PaymentMethodPrebook.IsDeposited,
                    DepositNo = model.PaymentMethodPrebook.DepositNo,
                    DepositDate = model.PaymentMethodPrebook.DepositDate,
                    DepositStatus = model.PaymentMethodPrebook.IsDeposited == true ? "นำฝากแล้ว" : "รอนำฝาก",
                    BankAccountID = model.PaymentMethodPrebook.BankAccountID,
        ...
        public async Task ValidateAsync(DatabaseContext db, PaymentFormTypePreBook paymentFormType, bool? fromOffline = false)
        {
            ValidateException ex = new ValidateException();
            PaymentMethodPreBookDTO PaymentMethod = new PaymentMethodPreBookDTO();
            ...
            else
            {
                ...
                if (this.PaymentMethodType.Key == PaymentMethodKeys.CashierCheque)
                {
                    ...
                    if (paymentFormType != PaymentFormTypePreBook.PreTransfer && this.PayToCompany == null)
                    {
                        var errMsg = await db.ErrorMessages.Where(o => o.Key == "ERR0006").FirstAsync();
                        string desc = PaymentMethod.GetType().GetProperty(nameof(PaymentMethod.PayToCompany)).GetCustomAttribute<DescriptionAttribute>().Description;
                        var msg = errMsg.Message.Replace("[field]", desc);
