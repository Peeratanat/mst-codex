...
namespace Base.DTOs.CTM
{
	public class ContactDTO
	{
		...
		public async static Task<ContactDTO> CreateFormatCitizenFromModelAsync(models.CTM.Contact model, models.DatabaseContext DB)
		{
			if (model != null)
			{
				ContactDTO result = new ContactDTO()
		...
		public static async Task<ContactDTO> CreateCustomerAnswerModelAsync(ContactDTO contact, Guid? userID, DatabaseContext DB, DbQueryContext dbQuery)
		{
			ContactDTO result = new ContactDTO();
		...
		public static ContactDTO CreateFromModel(models.CTM.Contact model)
		{
			if (model != null)
			{
				ContactDTO result = new ContactDTO()
