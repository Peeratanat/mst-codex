...
namespace Base.DTOs.EXT
{
	public class DistrictDTO
	{
		...
		public void ToModel(ref dbqGetDistrictList model)
		{
		...
		public static DistrictDTO CreateFromQuery(dbqGetDistrictList model, DatabaseContext db)
		{
			if (model != null)
			{
				var result = new DistrictDTO();
				result.province_code = model.province_code;
