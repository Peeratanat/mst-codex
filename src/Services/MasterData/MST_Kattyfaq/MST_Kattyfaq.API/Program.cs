...
using MST_Kattyfaq.API.HealthCheck;
using MST_Kattyfaq.API.Middleware;
using MST_Kattyfaq.API;
using Newtonsoft.Json.Converters;
using Swashbuckle.AspNetCore.SwaggerUI;
using System.Text;
using APSharing.WebHttpClient;
using MST_Kattyfaq.Service;
using Serilog;
...
var basePath = "api/v1/apcrm-mst-kattyfaq-service";
