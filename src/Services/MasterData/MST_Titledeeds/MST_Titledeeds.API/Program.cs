...
using MST_Titledeeds.API.HealthCheck;
using MST_Titledeeds.API.Middleware;
using MST_Titledeeds.API;
using Newtonsoft.Json.Converters;
using Swashbuckle.AspNetCore.SwaggerUI;
using System.Text;
using APSharing.WebHttpClient;
using MST_Titledeeds.Service;
using Serilog;
...
var basePath = "api/v1/apcrm-mst-titledeeds-service";
