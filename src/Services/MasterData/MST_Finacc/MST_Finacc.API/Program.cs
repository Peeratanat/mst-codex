...
using MST_Finacc.API;
using MST_Finacc.API.HealthCheck;
using MST_Finacc.API.Middleware;
using MST_Finacc.Service;
...
var basePath = "api/v1/apcrm-mst-finacc-service";
