...
using MST_Unitmeter.API.HealthCheck;
using MST_Unitmeter.API.Middleware;
using MST_Unitmeter.API;
...
var basePath = "api/v1/apcrm-mst-unitmeter-service";
