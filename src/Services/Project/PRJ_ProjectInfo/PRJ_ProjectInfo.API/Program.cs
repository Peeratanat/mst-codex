...
using PRJ_ProjectInfo.API.HealthCheck;
using PRJ_ProjectInfo.API.Middleware;
using PRJ_ProjectInfo.API;
using Newtonsoft.Json.Converters;
using Swashbuckle.AspNetCore.SwaggerUI;
using System.Text;
using APSharing.WebHttpClient;
using PRJ_ProjectInfo.Service;
using Serilog;
...
ServicesDependencyContainer.RegisterServices(builder.Services);
MSTGeneralRepositoriesDependencyContainer.RegisterServices(builder.Services);
...
var basePath = "api/v1/apcrm-prj-projectinfo-service";
