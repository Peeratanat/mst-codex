...
using PRJ_CombineUnit.API.HealthCheck;
using PRJ_CombineUnit.API.Middleware;
using PRJ_CombineUnit.API;
using Newtonsoft.Json.Converters;
using Swashbuckle.AspNetCore.SwaggerUI;
using System.Text;
using APSharing.WebHttpClient;
using PRJ_CombineUnit.Service;
using Serilog;
...
var basePath = "api/v1/apcrm-prj-combineunit-service";
