...
using Auth_RolePermission.API.HealthCheck;
using Auth_RolePermission.API.Middleware;
using Auth_RolePermission.API;
using Newtonsoft.Json.Converters;
using Swashbuckle.AspNetCore.SwaggerUI;
using System.Text;
using APSharing.WebHttpClient;
using Auth_RolePermission.Service;
using Serilog;
...
{
    options.Configuration = EnvironmentHelper.GetEnvironment("redis_url");
});
//builder.Services.AddDistributedMemoryCache(); // localhost
...
var basePath = "api/v1/apcrm-auth-rolepermission-service";
