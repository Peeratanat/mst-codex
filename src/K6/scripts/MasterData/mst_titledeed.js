...
const endpoints = [
  { path: 'TitleDeeds', tag: 'TitleDeeds',  duration: 1000 },
  { path: 'TitleDeeds/GetTitleDeedStatus', tag: 'TitleDeeds_GetTitleDeedStatus',  duration: 1000 },
  { path: 'TitleDeeds/GetTitleDeedStatusSelectAllList', tag: 'TitleDeeds_GetTitleDeedStatusSelectAllList',  duration: 1000 },
];
mapEndpoints(endpoints)

const service = "api/v1/apcrm-mst-titledeeds-service"
