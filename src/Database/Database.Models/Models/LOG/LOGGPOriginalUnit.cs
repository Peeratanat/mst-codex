...
{
    [Description("LOGGPOriginalUnit")]
    [Table("LOGGPOriginalUnit", Schema = Schema.LOG)]
    public class LOGGPOriginalUnit : BaseEntityWithoutMigrate
    {
        public Guid? OriginalUnitID { get; set; }
