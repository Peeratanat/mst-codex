...
{
    [Description("Header ข้อมูลการ Post GL RV รายการที่ Post มากกว่า 1 ใบเสร็จ")]
    [Table("PostGLHeader_RVMultiplePayment", Schema = Schema.ACCOUNT)]
    public class PostGLHeader_RVMultiplePayment : BaseEntity
    {
