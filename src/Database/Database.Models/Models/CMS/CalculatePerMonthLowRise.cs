...
{
    [Description("คำนวณค่า Commission ประจำเดือนโครงการแนวราบ")]
    [Table("CalculatePerMonthLowRise", Schema = Schema.COMMISSION)]
    public class CalculatePerMonthLowRise : BaseEntity
    {
        ...
        [Description("จำนวนเดือนที่เปิดขายมาแล้ว")]
        ...
        [ForeignKey("CommissionPercentTypeMasterCenterID")]
        public MST.MasterCenter CommissionPercentType { get; set; }
        ...
        [Description("มูลค่า New Launch ต่อแปลง")]
        [Column(TypeName = "Money")]
