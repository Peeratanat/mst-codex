...
namespace Database.Models.PRM
{
    ...
    [Table("SalePromotionDeliveryItem", Schema = Schema.PROMOTION)]
    public class SalePromotionDeliveryItem : BaseEntity
    {
        [Description("ผูกการส่งมอบโปรโมชั่นขาย")]
        public Guid? SalePromotionDeliveryID { get; set; }
        [ForeignKey("SalePromotionDeliveryID")]
        public SalePromotionDelivery SalePromotionDelivery { get; set; }
