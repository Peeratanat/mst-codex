...
{
    [Description("รายการจ่ายโปรโมชั่นขาย (จากระบบ Stock)")]
    [Table("SalePromotionStockReceiveItem", Schema = Schema.PROMOTION)]
    public class SalePromotionStockReceiveItem : BaseEntity
    {
